			...
			for(int j = 0; j < CountColumn; j++) {
				...
				case 0:
					...
					for(int k = 1; k < 3; k++) {
						switch(k) {
						case 1:
							uTmp2 = TProduct::VProduct[i]->Code;
							break;
						case 2:
							uTmp2 = TProduct::VProduct[i]->Name;
							break;
						}
					...
					break;
				case 1:
					uTmp = TProduct::VProduct[i]->Code;
					break;
				case 2:
					uTmp = TProduct::VProduct[i]->Name;
					break;
				case 3:
					uTmp = TProduct::VProduct[i]->PurchaseCash.StringFormat();
					break;
				case 4:
					uTmp = TProduct::VProduct[i]->SellingPrice.StringFormat();
					break;
				case 5:
//					uTmp.sprintf(L"%7d", TProduct::VProduct[i]->CountBalance[TShopUnits::upp[0]]);
					uTmp = TProduct::VProduct[i]->CountBalance[TShopUnits::upp[0]].StringFormat();
					break;
				}
