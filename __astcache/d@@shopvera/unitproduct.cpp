...
//			*TmpProduct = *(TProduct::VProduct[FormProductList->MyListView->ipp[FormProductList->MyListView->ItemIndex]]);
			TmpProduct = TObjectManager<TProduct>::GetList()[FormProductList->MyListView->ipp[FormProductList->MyListView->ItemIndex]];
...
//		*(TObjectManager<TProduct>::GetList()[FormProductList->MyListView->ipp[FormProductList->MyListView->ItemIndex]]) = *TmpProduct;
