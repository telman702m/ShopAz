...
void __fastcall TFormProvisionerData::FormShow(TObject *Sender)
{
	switch(FormProvisionerList->ButtonAction) {
		case TButtonAction::BA_VIEW:
			TmpProvisioner = TProvisioner::VProvisioners[FormProvisionerList->MyListView->ipp[FormProvisionerList->MyListView->ItemIndex]];
...
//	TProvisioner::VProvisioners[FormProvisionerList->MyListView->ipp[FormProvisionerList->MyListView->ItemIndex]] = TmpProvisioner;
...
//	TProvisioner::VProvisioners.push_back(TmpProvisioner);
//	TmpProvisioner = new TProvisioner();
