...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.IBWrapper.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TIBLibExt;
class DELPHICLASS TIBDatabaseExt;
class DELPHICLASS TIBVariablesExt;
class DELPHICLASS TIBStatementExt;
//-- type declarations -------------------------------------------------------
...
private:
	...
	void __fastcall LoadBase(const System::UnicodeString AVendorHome, const System::UnicodeString AVendorLib, bool AThreadSafe, const System::UnicodeString *ALibNames, const int ALibNames_High);
...
#ifndef _WIN64
	__property NativeInt Status = {read=FStatus, nodefault};
#else /* _WIN64 */
...
private:
	...
	bool __fastcall GetIsNulls(unsigned ARowIndex);
	...
	Firedac::Phys::Ibcli::PXSQLVAR_V1 __fastcall GetDataXSQLVarV1(unsigned ARowIndex);
	Firedac::Phys::Ibcli::PXSQLVAR_V2 __fastcall GetDataXSQLVarV2(unsigned ARowIndex);
	...
	TIBUpdateStatus __fastcall GetUpdates(unsigned ARowIndex);
...
protected:
	...
	__property Firedac::Phys::Ibcli::PXSQLVAR_V2 DataXSQLVarV2[unsigned ARowIndex] = {read=GetDataXSQLVarV2};
	__property Firedac::Phys::Ibcli::PXSQLVAR_V1 DataXSQLVarV1[unsigned ARowIndex] = {read=GetDataXSQLVarV1};
...
public:
	...
	__classmethod unsigned __fastcall GetDataTypeSize(short AType, unsigned ASize);
	...
	System::UnicodeString __fastcall DumpValue(unsigned ARowIndex);
	System::UnicodeString __fastcall DumpSQLDataType();
	__property bool IsNulls[unsigned ARowIndex] = {read=GetIsNulls};
	__property TIBUpdateStatus Updates[unsigned ARowIndex] = {read=GetUpdates};
	...
	__property unsigned DataSize = {read=GetDataSize, write=FDataSize, nodefault};
...
public:
	...
	unsigned __fastcall Read(System::PByte ABuff, unsigned ABuffLen);
	void __fastcall Write(System::PByte ABuff, unsigned ABuffLen);
...
public:
	...
	void __fastcall GetData(void * ASrc, void * &ApData, /* out */ unsigned &ALen);
	void __fastcall SetData(void * ADest, void * ApData, unsigned ALen);
	__property TIBDatabase* Database = {read=FDatabase};
	__property TIBTransaction* Transaction = {read=FTransaction};
...
private:
	...
	unsigned __fastcall GetMaximumBatchSize();
...
public:
	...
	__property unsigned MaximumBatchSize = {read=GetMaximumBatchSize, nodefault};
...
protected:
	void __fastcall QueryInfo(const _di_TRequestProc ARequest, const _di_TParseFunc AParse);
...
{
	typedef TIBLib inherited;
	
protected:
	virtual void __fastcall LoadEntries();
	
public:
	Firedac::Phys::Ibcli::IMaster* FFBMaster;
	Firedac::Phys::Ibcli::IUtil* FFBUtil;
	Firedac::Phys::Ibcli::IInt128* FFBInt128;
	Firedac::Phys::Ibcli::IDecFloat16* FFBDec16;
	Firedac::Phys::Ibcli::IDecFloat34* FFBDec34;
	Firedac::Phys::Ibcli::Tfb_get_master_interface Ffb_get_master_interface;
	Firedac::Phys::Ibcli::Tfb_dsql_set_timeout Ffb_dsql_set_timeout;
	Firedac::Phys::Ibcli::Tfb_get_statement_interface Ffb_get_statement_interface;
	HIDESBASE void __fastcall LoadFB(const System::UnicodeString AVendorHome, const System::UnicodeString AVendorLib, bool AEmbedded, bool AThreadSafe);
	virtual void __fastcall Unload();
public:
	/* TIBLib.Create */ inline __fastcall TIBLibExt(const System::UnicodeString ADriverID, System::TObject* AOwningObj) : TIBLib(ADriverID, AOwningObj) { }
	/* TIBLib.Destroy */ inline __fastcall virtual ~TIBLibExt() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TIBDatabaseExt : public TIBDatabase
{
	typedef TIBDatabase inherited;
	
private:
	Firedac::Phys::Ibcli::IStatus* FIStatus;
	
public:
	__fastcall TIBDatabaseExt(TIBEnv* AEnv, System::TObject* AOwningObj);
	__fastcall TIBDatabaseExt(TIBEnv* AEnv, void * AHandle, System::TObject* AOwningObj);
	__fastcall virtual ~TIBDatabaseExt();
	__property Firedac::Phys::Ibcli::IStatus* IStatus = {read=FIStatus};
};
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TIBVariablesExt : public TIBVariables
{
	typedef TIBVariables inherited;
	
private:
	Firedac::Phys::Ibcli::IMessageMetadata* FFBMeta;
	
public:
	void __fastcall Unprepare();
public:
	/* TIBVariables.Create */ inline __fastcall TIBVariablesExt(TIBStatement* AStatement) : TIBVariables(AStatement) { }
	/* TIBVariables.Destroy */ inline __fastcall virtual ~TIBVariablesExt() { }
...
class PASCALIMPLEMENTATION TIBStatementExt : public TIBStatement
{
	typedef TIBStatement inherited;
	
private:
	Firedac::Phys::Ibcli::IStatement* FFBStatement;
	unsigned FTimeout;
	void __fastcall SetTimeout(const unsigned AValue);
	void __fastcall UpdateTimeout();
...
public:
	...
	__property int sql_stmt_blob_align = {read=GetSQLInfoInt, index=30, nodefault};
public:
	/* TIBStatement.Create */ inline __fastcall TIBStatementExt(TIBDatabase* ADatabase, TIBTransaction* ATransaction, System::TObject* AOwningObj) : TIBStatement(ADatabase, ATransaction, AOwningObj) { }
	/* TIBStatement.Destroy */ inline __fastcall virtual ~TIBStatementExt() { }
	
};


//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TIBPageSize ps32768;
}	/* namespace Ibwrapper */
}	/* namespace Phys */
}	/* namespace Firedac */
