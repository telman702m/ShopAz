...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.IBMeta.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TFDPhysIBMetadataExt;
...
class PASCALIMPLEMENTATION TFDPhysIBMetadataExt : public TFDPhysIBMetadata
{
	typedef TFDPhysIBMetadata inherited;
	
protected:
	virtual bool __fastcall GetAsyncNativeTimeout();
public:
	/* TFDPhysIBMetadata.Create */ inline __fastcall TFDPhysIBMetadataExt(Firedac::Phys::TFDPhysConnection* const AConnection, TFDPhysIBBrand ABrand, unsigned __int64 AServerVersion, unsigned __int64 AClientVersion, int ADialect, bool AIsUnicode) : TFDPhysIBMetadata(AConnection, ABrand, AServerVersion, AClientVersion, ADialect, AIsUnicode) { }
	
public:
	/* TFDPhysConnectionMetadata.Destroy */ inline __fastcall virtual ~TFDPhysIBMetadataExt() { }
...
//-- var, const, procedure ---------------------------------------------------
static const System::Int8 csIDNone = System::Int8(0x0);
static const System::Int8 csIDOctets = System::Int8(0x1);
static const System::Int8 csIDUnicodeFSS = System::Int8(0x3);
static const System::Int8 csIDFBUtf8 = System::Int8(0x4);
static const System::Int8 csIDUnicodeBE = System::Int8(0x8);
static const System::Int8 csIDIBUtf8 = System::Int8(0x3b);
static const System::Int8 csIDUnicodeLE = System::Int8(0x40);
}	/* namespace Ibmeta */
}	/* namespace Phys */
}	/* namespace Firedac */
