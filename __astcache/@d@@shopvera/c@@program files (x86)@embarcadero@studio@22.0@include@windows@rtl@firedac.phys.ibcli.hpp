...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.IBCli.pas' rev: 35.00 (Windows)
...
class DELPHICLASS IVersioned;
class DELPHICLASS IReferenceCounted;
class DELPHICLASS IDisposable;
class DELPHICLASS IStatus;
class DELPHICLASS IDecFloat16;
class DELPHICLASS IDecFloat34;
class DELPHICLASS IInt128;
class DELPHICLASS IUtil;
class DELPHICLASS IMaster;
class DELPHICLASS IMessageMetadata;
class DELPHICLASS IStatement;
//-- type declarations -------------------------------------------------------
...
typedef FB_DEC16 *PFB_DEC16;

struct DECLSPEC_DRECORD FB_DEC16
{
public:
	System::StaticArray<unsigned __int64, 1> fb_data;
};


typedef FB_DEC34 *PFB_DEC34;

struct DECLSPEC_DRECORD FB_DEC34
{
public:
	System::StaticArray<unsigned __int64, 2> fb_data;
};


typedef FB_I128 *PFB_I128;

struct DECLSPEC_DRECORD FB_I128
{
public:
	System::StaticArray<unsigned __int64, 2> fb_data;
};
...
typedef ISC_TIME_TZ *PISC_TIME_TZ;

struct DECLSPEC_DRECORD ISC_TIME_TZ
{
public:
	unsigned utc_time;
	System::Word time_zone;
};


typedef ISC_TIME_TZ_EX *PISC_TIME_TZ_EX;

struct DECLSPEC_DRECORD ISC_TIME_TZ_EX
{
public:
	unsigned utc_time;
	System::Word time_zone;
...
typedef ISC_TIMESTAMP_TZ *PISC_TIMESTAMP_TZ;

struct DECLSPEC_DRECORD ISC_TIMESTAMP_TZ
{
public:
...
typedef ISC_TIMESTAMP_TZ_EX *PISC_TIMESTAMP_TZ_EX;

struct DECLSPEC_DRECORD ISC_TIMESTAMP_TZ_EX
{
public:
	ISC_TIMESTAMP utc_timestamp;
	System::Word time_zone;
...
typedef int __stdcall (*FB_SHUTDOWN_CALLBACK_FUNC)(int reason, int mask, void * arg);

typedef NativeInt *NativeIntPtr;

typedef unsigned *CardinalPtr;

typedef PFB_DEC16 FB_DEC16Ptr;

typedef PFB_DEC34 FB_DEC34Ptr;

typedef PFB_I128 FB_I128Ptr;

typedef PISC_TIME_TZ ISC_TIME_TZPtr;

typedef PISC_TIMESTAMP_TZ ISC_TIMESTAMP_TZPtr;

typedef PISC_TIME_TZ_EX ISC_TIME_TZ_EXPtr;

typedef PISC_TIMESTAMP_TZ_EX ISC_TIMESTAMP_TZ_EXPtr;

#ifndef _WIN64
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IVersioned : public System::TObject
{
	typedef System::TObject inherited;
	
	
protected:
	class DELPHICLASS VersionedVTable;
	class PASCALIMPLEMENTATION VersionedVTable : public System::TObject
	{
		typedef System::TObject inherited;
	...
	public:
		NativeInt version;
	public:
		/* TObject.Create */ inline __fastcall VersionedVTable() : System::TObject() { }
		/* TObject.Destroy */ inline __fastcall virtual ~VersionedVTable() { }
...
public:
	VersionedVTable* vTable;
	static const System::Int8 VERSION = System::Int8(0x1);
	
public:
	/* TObject.Create */ inline __fastcall IVersioned() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IVersioned() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IReferenceCounted : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef void __cdecl (*IReferenceCounted_addRefPtr)(IReferenceCounted* This);
	
	typedef int __cdecl (*IReferenceCounted_releasePtr)(IReferenceCounted* This);
	
	class DELPHICLASS ReferenceCountedVTable;
	class PASCALIMPLEMENTATION ReferenceCountedVTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
		
	public:
		IReferenceCounted::IReferenceCounted_addRefPtr addRef;
		IReferenceCounted::IReferenceCounted_releasePtr release;
	public:
		/* TObject.Create */ inline __fastcall ReferenceCountedVTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~ReferenceCountedVTable() { }
...
public:
	static const System::Int8 VERSION = System::Int8(0x2);
	
	void __fastcall addRef();
	int __fastcall release();
public:
	/* TObject.Create */ inline __fastcall IReferenceCounted() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IReferenceCounted() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IDisposable : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef void __cdecl (*IDisposable_disposePtr)(IDisposable* This);
	
	class DELPHICLASS DisposableVTable;
	class PASCALIMPLEMENTATION DisposableVTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
		
	public:
		IDisposable::IDisposable_disposePtr dispose;
	public:
		/* TObject.Create */ inline __fastcall DisposableVTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~DisposableVTable() { }
...
public:
	/* TObject.Create */ inline __fastcall IDisposable() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IDisposable() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IStatus : public IDisposable
{
	typedef IDisposable inherited;
	
	
protected:
	typedef unsigned __cdecl (*IStatus_getStatePtr)(IStatus* This);
	
	typedef NativeIntPtr __cdecl (*IStatus_getErrorsPtr)(IStatus* This);
	
	class DELPHICLASS StatusVTable;
	class PASCALIMPLEMENTATION StatusVTable : public IDisposable::DisposableVTable
	{
		typedef IDisposable::DisposableVTable inherited;
		
	public:
		void *init;
		IStatus::IStatus_getStatePtr getState;
		void *setErrors2;
		void *setWarnings2;
		void *setErrors;
		void *setWarnings;
		IStatus::IStatus_getErrorsPtr getErrors;
		void *getWarnings;
		void *clone;
	public:
		/* TObject.Create */ inline __fastcall StatusVTable() : IDisposable::DisposableVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~StatusVTable() { }
...
public:
	static const System::Int8 VERSION = System::Int8(0x3);
	
	static const unsigned STATE_WARNINGS = unsigned(0x1);
	
	static const unsigned STATE_ERRORS = unsigned(0x2);
	
	static const int RESULT_ERROR = int(-1);
	
	static const int RESULT_OK = int(0);
	
	static const int RESULT_NO_DATA = int(1);
	
	static const int RESULT_SEGMENT = int(2);
	
	unsigned __fastcall getState();
	NativeIntPtr __fastcall getErrors();
public:
	/* TObject.Create */ inline __fastcall IStatus() : IDisposable() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IStatus() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IDecFloat16 : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef void __cdecl (*IDecFloat16_toStringPtr)(IDecFloat16* This, IStatus* status, PFB_DEC16 from, unsigned bufferLength, char * buffer);
	
	typedef void __cdecl (*IDecFloat16_fromStringPtr)(IDecFloat16* This, IStatus* status, char * from, PFB_DEC16 to_);
	
	class DELPHICLASS DecFloat16VTable;
	class PASCALIMPLEMENTATION DecFloat16VTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
		
	public:
		void *toBcd;
		IDecFloat16::IDecFloat16_toStringPtr toString;
		void *fromBcd;
		IDecFloat16::IDecFloat16_fromStringPtr fromString;
	public:
		/* TObject.Create */ inline __fastcall DecFloat16VTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~DecFloat16VTable() { }
...
public:
	...
	static const unsigned BCD_SIZE = unsigned(0x10);
	
	static const unsigned STRING_SIZE = unsigned(0x18);
	
	HIDESBASE void __fastcall toString(IStatus* status, PFB_DEC16 from, unsigned bufferLength, char * buffer);
	void __fastcall fromString(IStatus* status, char * from, PFB_DEC16 to_);
public:
	/* TObject.Create */ inline __fastcall IDecFloat16() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IDecFloat16() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IDecFloat34 : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef void __cdecl (*IDecFloat34_toStringPtr)(IDecFloat34* This, IStatus* status, PFB_DEC34 from, unsigned bufferLength, char * buffer);
	
	typedef void __cdecl (*IDecFloat34_fromStringPtr)(IDecFloat34* This, IStatus* status, char * from, PFB_DEC34 to_);
	
	class DELPHICLASS DecFloat34VTable;
	class PASCALIMPLEMENTATION DecFloat34VTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
		
	public:
		void *toBcd;
		IDecFloat34::IDecFloat34_toStringPtr toString;
		void *fromBcd;
		IDecFloat34::IDecFloat34_fromStringPtr fromString;
	public:
		/* TObject.Create */ inline __fastcall DecFloat34VTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~DecFloat34VTable() { }
...
public:
	...
	static const unsigned BCD_SIZE = unsigned(0x22);
	
	static const unsigned STRING_SIZE = unsigned(0x2b);
	
	HIDESBASE void __fastcall toString(IStatus* status, PFB_DEC34 from, unsigned bufferLength, char * buffer);
	void __fastcall fromString(IStatus* status, char * from, PFB_DEC34 to_);
public:
	/* TObject.Create */ inline __fastcall IDecFloat34() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IDecFloat34() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IInt128 : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef void __cdecl (*IInt128_toStringPtr)(IInt128* This, IStatus* status, PFB_I128 from, int scale, unsigned bufferLength, char * buffer);
	
	typedef void __cdecl (*IInt128_fromStringPtr)(IInt128* This, IStatus* status, int scale, char * from, PFB_I128 to_);
	
	class DELPHICLASS Int128VTable;
	class PASCALIMPLEMENTATION Int128VTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
		
	public:
		IInt128::IInt128_toStringPtr toString;
		IInt128::IInt128_fromStringPtr fromString;
	public:
		/* TObject.Create */ inline __fastcall Int128VTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~Int128VTable() { }
...
public:
	...
	static const unsigned STRING_SIZE = unsigned(0x2e);
	
	HIDESBASE void __fastcall toString(IStatus* status, PFB_I128 from, int scale, unsigned bufferLength, char * buffer);
	void __fastcall fromString(IStatus* status, int scale, char * from, PFB_I128 to_);
public:
	/* TObject.Create */ inline __fastcall IInt128() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IInt128() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IUtil : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef IDecFloat16* __cdecl (*IUtil_getDecFloat16Ptr)(IUtil* This, IStatus* status);
	
	typedef IDecFloat34* __cdecl (*IUtil_getDecFloat34Ptr)(IUtil* This, IStatus* status);
	
	typedef void __cdecl (*IUtil_decodeTimeTzPtr)(IUtil* This, IStatus* status, PISC_TIME_TZ timeTz, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	
	typedef void __cdecl (*IUtil_decodeTimeStampTzPtr)(IUtil* This, IStatus* status, PISC_TIMESTAMP_TZ timeStampTz, CardinalPtr year, CardinalPtr month, CardinalPtr day, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	
	typedef void __cdecl (*IUtil_encodeTimeTzPtr)(IUtil* This, IStatus* status, PISC_TIME_TZ timeTz, unsigned hours, unsigned minutes, unsigned seconds, unsigned fractions, char * timeZone);
	
	typedef void __cdecl (*IUtil_encodeTimeStampTzPtr)(IUtil* This, IStatus* status, PISC_TIMESTAMP_TZ timeStampTz, unsigned year, unsigned month, unsigned day, unsigned hours, unsigned minutes, unsigned seconds, unsigned fractions, char * timeZone);
	
	typedef IInt128* __cdecl (*IUtil_getInt128Ptr)(IUtil* This, IStatus* status);
	
	typedef void __cdecl (*IUtil_decodeTimeTzExPtr)(IUtil* This, IStatus* status, PISC_TIME_TZ_EX timeTz, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	
	typedef void __cdecl (*IUtil_decodeTimeStampTzExPtr)(IUtil* This, IStatus* status, PISC_TIMESTAMP_TZ_EX timeStampTz, CardinalPtr year, CardinalPtr month, CardinalPtr day, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	
	class DELPHICLASS UtilVTable;
	class PASCALIMPLEMENTATION UtilVTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
	...
	public:
		...
		void *getXpbBuilder;
		void *setOffsets;
		IUtil::IUtil_getDecFloat16Ptr getDecFloat16;
		IUtil::IUtil_getDecFloat34Ptr getDecFloat34;
		IUtil::IUtil_decodeTimeTzPtr decodeTimeTz;
		IUtil::IUtil_decodeTimeStampTzPtr decodeTimeStampTz;
		IUtil::IUtil_encodeTimeTzPtr encodeTimeTz;
		IUtil::IUtil_encodeTimeStampTzPtr encodeTimeStampTz;
		IUtil::IUtil_getInt128Ptr getInt128;
		IUtil::IUtil_decodeTimeTzExPtr decodeTimeTzEx;
		IUtil::IUtil_decodeTimeStampTzExPtr decodeTimeStampTzEx;
	public:
		/* TObject.Create */ inline __fastcall UtilVTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~UtilVTable() { }
...
public:
	static const System::Int8 VERSION = System::Int8(0x4);
	
	IDecFloat16* __fastcall getDecFloat16(IStatus* status);
	IDecFloat34* __fastcall getDecFloat34(IStatus* status);
	IInt128* __fastcall getInt128(IStatus* status);
	void __fastcall decodeTimeTz(IStatus* status, PISC_TIME_TZ timeTz, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	void __fastcall decodeTimeStampTz(IStatus* status, PISC_TIMESTAMP_TZ timeStampTz, CardinalPtr year, CardinalPtr month, CardinalPtr day, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	void __fastcall encodeTimeTz(IStatus* status, PISC_TIME_TZ timeTz, unsigned hours, unsigned minutes, unsigned seconds, unsigned fractions, char * timeZone);
	void __fastcall encodeTimeStampTz(IStatus* status, PISC_TIMESTAMP_TZ timeStampTz, unsigned year, unsigned month, unsigned day, unsigned hours, unsigned minutes, unsigned seconds, unsigned fractions, char * timeZone);
	void __fastcall decodeTimeTzEx(IStatus* status, PISC_TIME_TZ_EX timeTz, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
	void __fastcall decodeTimeStampTzEx(IStatus* status, PISC_TIMESTAMP_TZ_EX timeStampTz, CardinalPtr year, CardinalPtr month, CardinalPtr day, CardinalPtr hours, CardinalPtr minutes, CardinalPtr seconds, CardinalPtr fractions, unsigned timeZoneBufferLength, char * timeZoneBuffer);
public:
	/* TObject.Create */ inline __fastcall IUtil() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IUtil() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IMaster : public IVersioned
{
	typedef IVersioned inherited;
	
	
protected:
	typedef IStatus* __cdecl (*IMaster_getStatusPtr)(IMaster* This);
	
	typedef IUtil* __cdecl (*IMaster_getUtilInterfacePtr)(IMaster* This);
	
	class DELPHICLASS MasterVTable;
	class PASCALIMPLEMENTATION MasterVTable : public IVersioned::VersionedVTable
	{
		typedef IVersioned::VersionedVTable inherited;
		
	public:
		IMaster::IMaster_getStatusPtr getStatus;
		void *getDispatcher;
		...
		void *serverMode;
		IMaster::IMaster_getUtilInterfacePtr getUtilInterface;
		void *getConfigManager;
		void *getProcessExiting;
	public:
		/* TObject.Create */ inline __fastcall MasterVTable() : IVersioned::VersionedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~MasterVTable() { }
...
public:
	...
	IStatus* __fastcall getStatus();
	IUtil* __fastcall getUtilInterface();
public:
	/* TObject.Create */ inline __fastcall IMaster() : IVersioned() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IMaster() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IMessageMetadata : public IReferenceCounted
{
	typedef IReferenceCounted inherited;
	
	
protected:
	typedef char * __cdecl (*IMessageMetadata_getFieldPtr)(IMessageMetadata* This, IStatus* status, unsigned index);
	
	typedef char * __cdecl (*IMessageMetadata_getRelationPtr)(IMessageMetadata* This, IStatus* status, unsigned index);
	
	typedef char * __cdecl (*IMessageMetadata_getOwnerPtr)(IMessageMetadata* This, IStatus* status, unsigned index);
	
	typedef char * __cdecl (*IMessageMetadata_getAliasPtr)(IMessageMetadata* This, IStatus* status, unsigned index);
	
	class DELPHICLASS MessageMetadataVTable;
	class PASCALIMPLEMENTATION MessageMetadataVTable : public IReferenceCounted::ReferenceCountedVTable
	{
		typedef IReferenceCounted::ReferenceCountedVTable inherited;
		
	public:
		void *getCount;
		IMessageMetadata::IMessageMetadata_getFieldPtr getField;
		IMessageMetadata::IMessageMetadata_getRelationPtr getRelation;
		IMessageMetadata::IMessageMetadata_getOwnerPtr getOwner;
		IMessageMetadata::IMessageMetadata_getAliasPtr getAlias;
		void *getType;
		void *isNullable;
		void *getSubType;
		void *getLength;
		...
		void *getAlignment;
		void *getAlignedLength;
	public:
		/* TObject.Create */ inline __fastcall MessageMetadataVTable() : IReferenceCounted::ReferenceCountedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~MessageMetadataVTable() { }
...
public:
	...
	char * __fastcall getField(IStatus* status, unsigned index);
	char * __fastcall getRelation(IStatus* status, unsigned index);
	char * __fastcall getOwner(IStatus* status, unsigned index);
	char * __fastcall getAlias(IStatus* status, unsigned index);
public:
	/* TObject.Create */ inline __fastcall IMessageMetadata() : IReferenceCounted() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IMessageMetadata() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION IStatement : public IReferenceCounted
{
	typedef IReferenceCounted inherited;
	
	
protected:
	typedef IMessageMetadata* __cdecl (*IStatement_getInputMetadataPtr)(IStatement* This, IStatus* status);
	
	typedef IMessageMetadata* __cdecl (*IStatement_getOutputMetadataPtr)(IStatement* This, IStatus* status);
	
	class DELPHICLASS StatementVTable;
	class PASCALIMPLEMENTATION StatementVTable : public IReferenceCounted::ReferenceCountedVTable
	{
		typedef IReferenceCounted::ReferenceCountedVTable inherited;
	...
	public:
		...
		void *getType;
		void *getPlan;
		void *getAffectedRecords;
		IStatement::IStatement_getInputMetadataPtr getInputMetadata;
		IStatement::IStatement_getOutputMetadataPtr getOutputMetadata;
		void *execute;
		void *openCursor;
		void *setCursorName;
		void *free;
		...
		void *createBatch;
	public:
		/* TObject.Create */ inline __fastcall StatementVTable() : IReferenceCounted::ReferenceCountedVTable() { }
		/* TObject.Destroy */ inline __fastcall virtual ~StatementVTable() { }
...
public:
	...
	IMessageMetadata* __fastcall getInputMetadata(IStatus* status);
	IMessageMetadata* __fastcall getOutputMetadata(IStatus* status);
public:
	/* TObject.Create */ inline __fastcall IStatement() : IReferenceCounted() { }
	/* TObject.Destroy */ inline __fastcall virtual ~IStatement() { }
...
typedef int __stdcall (*TBLOB_close)(PBSTREAM Stream);

typedef int __stdcall (*TBLOB_display)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR field_name);

typedef int __stdcall (*TBLOB_dump)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR file_name);

typedef int __stdcall (*TBLOB_edit)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR field_name);

typedef int __stdcall (*TBLOB_get)(PBSTREAM Stream);

typedef int __stdcall (*TBLOB_load)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR file_name);

typedef PBSTREAM __stdcall (*TBLOB_open)(void * blob, PISC_SCHAR buffer, int length);

typedef int __stdcall (*TBLOB_put)(System::Int8 x, PBSTREAM Stream);

typedef int __stdcall (*TBLOB_text_dump)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR file_name);

typedef int __stdcall (*TBLOB_text_load)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR file_name);

typedef PBSTREAM __stdcall (*TBopen)(PISC_QUAD blob_id, void * database, void * transaction, PISC_SCHAR mode);

typedef NativeInt __stdcall (*Tisc_add_user)(PISC_STATUS status, PUSER_SEC_DATA user_data);

typedef NativeInt __stdcall (*Tisc_array_gen_sdl)(PISC_STATUS status, PISC_ARRAY_DESC_V1 desc, PISC_SHORT sdl_buffer_length, PISC_UCHAR sdl_buffer, PISC_SHORT sdl_length);

typedef NativeInt __stdcall (*Tisc_array_get_slice)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_QUAD array_id, PISC_ARRAY_DESC_V1 desc, void * array_, PISC_LONG slice_length);

typedef NativeInt __stdcall (*Tisc_array_lookup_bounds)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_SCHAR relation_name, PISC_SCHAR field_name, PISC_ARRAY_DESC_V1 desc);

typedef NativeInt __stdcall (*Tisc_array_lookup_desc)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_SCHAR relation_name, PISC_SCHAR field_name, PISC_ARRAY_DESC_V1 desc);

typedef NativeInt __stdcall (*Tisc_array_put_slice)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_QUAD array_id, PISC_ARRAY_DESC_V1 desc, void * array_, PISC_LONG slice_length);

typedef NativeInt __stdcall (*Tisc_array_set_desc)(PISC_STATUS status, PISC_SCHAR relation_name, PISC_SCHAR field_name, System::PSmallInt sql_dtype, System::PSmallInt sql_length, System::PSmallInt dimensions, PISC_ARRAY_DESC_V1 desc);

typedef NativeInt __stdcall (*Tisc_array_gen_sdl2)(PISC_STATUS status, PISC_ARRAY_DESC_V2 desc, PISC_SHORT sdl_buffer_length, PISC_UCHAR sdl_buffer, PISC_SHORT sdl_length);

typedef NativeInt __stdcall (*Tisc_array_get_slice2)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_QUAD array_id, PISC_ARRAY_DESC_V2 desc, void * array_, PISC_LONG slice_length);

typedef NativeInt __stdcall (*Tisc_array_lookup_bounds2)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_SCHAR relation_name, PISC_SCHAR field_name, PISC_ARRAY_DESC_V2 desc);

typedef NativeInt __stdcall (*Tisc_array_lookup_desc2)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_SCHAR relation_name, PISC_SCHAR field_name, PISC_ARRAY_DESC_V2 desc);

typedef NativeInt __stdcall (*Tisc_array_put_slice2)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_QUAD array_id, PISC_ARRAY_DESC_V2 desc, void * array_, PISC_LONG slice_length);

typedef NativeInt __stdcall (*Tisc_array_set_desc2)(PISC_STATUS status, PISC_SCHAR relation_name, PISC_SCHAR field_name, System::PSmallInt sql_dtype, System::PSmallInt sql_length, System::PSmallInt dimensions, PISC_ARRAY_DESC_V2 desc);

typedef NativeInt __stdcall (*Tisc_attach_database)(PISC_STATUS user_status, short file_length, PISC_SCHAR file_name, Pisc_db_handle handle, short dpb_length, PISC_SCHAR dpb);

typedef void __stdcall (*Tisc_blob_default_desc)(void * desc, PISC_UCHAR relation_name, PISC_UCHAR field_name);

typedef NativeInt __stdcall (*Tisc_blob_gen_bpb)(PISC_STATUS status, void * to_desc, void * from_desc, System::Word bpb_buffer_length, PISC_UCHAR bpb_buffer, System::Word &bpb_length);

typedef NativeInt __stdcall (*Tisc_blob_info)(PISC_STATUS user_status, Pisc_blob_handle blob_handle, short item_length, PISC_SCHAR items, short buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_blob_lookup_desc)(PISC_STATUS status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_UCHAR relation_name, PISC_UCHAR field_name, void * desc, PISC_UCHAR global);

typedef NativeInt __stdcall (*Tisc_blob_set_desc)(PISC_STATUS status, PISC_UCHAR relation_name, PISC_UCHAR field_name, short subtype, short charset, short segment_size, void * desc);

typedef NativeInt __stdcall (*Tisc_cancel_blob)(PISC_STATUS user_status, Pisc_blob_handle blob_handle);

typedef NativeInt __stdcall (*Tisc_cancel_events)(PISC_STATUS user_status, Pisc_db_handle handle, PISC_LONG id);

typedef NativeInt __stdcall (*Tisc_close)(PISC_STATUS user_status, PISC_SCHAR name);

typedef NativeInt __stdcall (*Tisc_close_blob)(PISC_STATUS user_status, Pisc_blob_handle blob_handle);

typedef NativeInt __stdcall (*Tisc_commit_retaining)(PISC_STATUS user_status, Pisc_tr_handle tra_handle);

typedef NativeInt __stdcall (*Tisc_commit_transaction)(PISC_STATUS user_status, Pisc_tr_handle tra_handle);

typedef NativeInt __stdcall (*Tisc_compile_request)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_req_handle req_handle, short blr_length, PISC_SCHAR blr);

typedef NativeInt __stdcall (*Tisc_compile_request2)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_req_handle req_handle, short blr_length, PISC_SCHAR blr);

typedef NativeInt __stdcall (*Tisc_create_blob)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, Pisc_blob_handle blob_handle, PISC_QUAD blob_id);

typedef NativeInt __stdcall (*Tisc_create_blob2)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, Pisc_blob_handle blob_handle, PISC_QUAD blob_id, short bpb_length, PISC_SCHAR bpb);

typedef NativeInt __stdcall (*Tisc_create_database)(PISC_STATUS user_status, short file_length, PISC_SCHAR file_name, Pisc_db_handle handle, short dpb_length, PISC_SCHAR dpb, short db_type);

typedef NativeInt __stdcall (*Tisc_database_info)(PISC_STATUS user_status, Pisc_db_handle handle, short item_length, PISC_SCHAR items, short buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_ddl)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, short length, PISC_SCHAR ddl);

typedef NativeInt __stdcall (*Tisc_declare)(PISC_STATUS user_status, PISC_SCHAR statement, PISC_SCHAR cursor);

typedef void __stdcall (*Tisc_decode_date)(PISC_QUAD date, PCTimeStructure times_arg);

typedef void __stdcall (*Tisc_decode_sql_date)(PISC_DATE date, PCTimeStructure times_arg);

typedef void __stdcall (*Tisc_decode_sql_time)(PISC_TIME sql_time, PCTimeStructure times_arg);

typedef void __stdcall (*Tisc_decode_timestamp)(PISC_TIMESTAMP date, PCTimeStructure times_arg);

typedef NativeInt __stdcall (*Tisc_delete_user)(PISC_STATUS status, PUSER_SEC_DATA user_data);

typedef NativeInt __stdcall (*Tisc_describe)(PISC_STATUS user_status, PISC_SCHAR name, void * sqlda);

typedef NativeInt __stdcall (*Tisc_describe_bind)(PISC_STATUS user_status, PISC_SCHAR name, void * sqlda);

typedef NativeInt __stdcall (*Tisc_detach_database)(PISC_STATUS user_status, Pisc_db_handle handle);

typedef NativeInt __stdcall (*Tisc_drop_database)(PISC_STATUS user_status, Pisc_db_handle handle);

typedef NativeInt __stdcall (*Tisc_dsql_alloc_statement2)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_stmt_handle stmt_handle);

typedef NativeInt __stdcall (*Tisc_dsql_allocate_statement)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_stmt_handle stmt_handle);

typedef NativeInt __stdcall (*Tisc_dsql_describe)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_describe_bind)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_exec_immed2)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, System::Word length, PISC_SCHAR statement, System::Word dialect, void * in_sqlda, void * out_sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_exec_immed3_m)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, System::Word Length, PISC_SCHAR statement, System::Word dialect, System::Word in_blr_length, PISC_SCHAR in_blr, System::Word in_msg_type, System::Word in_msg_length, PISC_SCHAR in_msg, System::Word out_blr_length, PISC_SCHAR out_blr, System::Word out_msg_type, System::Word out_msg_length, PISC_SCHAR out_msg);

typedef NativeInt __stdcall (*Tisc_dsql_execute)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, Pisc_stmt_handle stmt_handle, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_execute_immediate)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, System::Word length, PISC_SCHAR statement, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_execute_immediate_m)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, System::Word length, PISC_SCHAR statement, System::Word dialect, System::Word blr_length, PISC_SCHAR blr, System::Word msg_type, System::Word msg_length, PISC_SCHAR msg);

typedef NativeInt __stdcall (*Tisc_dsql_execute_m)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, Pisc_stmt_handle stmt_handle, System::Word blr_length, PISC_SCHAR blr, System::Word msg_type, System::Word msg_length, PISC_SCHAR msg);

typedef NativeInt __stdcall (*Tisc_dsql_execute2)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, Pisc_stmt_handle stmt_handle, System::Word dialect, void * in_sqlda, void * out_sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_execute2_m)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, Pisc_stmt_handle stmt_handle, System::Word in_blr_length, PISC_SCHAR in_blr, System::Word in_msg_type, System::Word in_msg_length, PISC_SCHAR in_msg, System::Word out_blr_length, PISC_SCHAR out_blr, System::Word out_msg_type, System::Word out_msg_length, PISC_SCHAR out_msg);

typedef NativeInt __stdcall (*Tisc_dsql_fetch)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_fetch_m)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word blr_length, PISC_SCHAR blr, System::Word msg_type, System::Word msg_length, PISC_SCHAR msg);

typedef NativeInt __stdcall (*Tisc_dsql_finish)(Pisc_db_handle db_handle);

typedef NativeInt __stdcall (*Tisc_dsql_free_statement)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word option);

typedef NativeInt __stdcall (*Tisc_dsql_insert)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_insert_m)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, System::Word blr_length, PISC_SCHAR blr, System::Word msg_type, System::Word msg_length, PISC_SCHAR msg);

typedef NativeInt __stdcall (*Tisc_dsql_prepare)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, Pisc_stmt_handle stmt_handle, System::Word length, PISC_SCHAR string_, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_dsql_prepare_m)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, Pisc_stmt_handle stmt_handle, System::Word length, PISC_SCHAR string_, System::Word dialect, System::Word item_length, PISC_SCHAR items, System::Word buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_dsql_release)(PISC_STATUS user_status, PISC_SCHAR name);

typedef NativeInt __stdcall (*Tisc_dsql_set_cursor_name)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, PISC_SCHAR cursor, System::Word type_);

typedef NativeInt __stdcall (*Tisc_dsql_sql_info)(PISC_STATUS user_status, Pisc_stmt_handle stmt_handle, short item_length, PISC_SCHAR items, short buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_embed_dsql_close)(PISC_STATUS user_status, PISC_SCHAR name);

typedef NativeInt __stdcall (*Tisc_embed_dsql_declare)(PISC_STATUS user_status, PISC_SCHAR stmt_name, PISC_SCHAR cursor);

typedef NativeInt __stdcall (*Tisc_embed_dsql_describe)(PISC_STATUS user_status, PISC_SCHAR stmt_name, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_describe_bind)(PISC_STATUS user_status, PISC_SCHAR stmt_name, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_execute)(PISC_STATUS user_status, Pisc_tr_handle trans_handle, PISC_SCHAR stmt_name, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_execute_immed)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, System::Word length, PISC_SCHAR string_, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_execute2)(PISC_STATUS user_status, Pisc_tr_handle trans_handle, PISC_SCHAR stmt_name, System::Word dialect, void * in_sqlda, void * out_sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_fetch)(PISC_STATUS user_status, PISC_SCHAR cursor_name, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_insert)(PISC_STATUS user_status, PISC_SCHAR cursor_name, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_open)(PISC_STATUS user_status, Pisc_tr_handle trans_handle, PISC_SCHAR cursor_name, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_open2)(PISC_STATUS user_status, Pisc_tr_handle trans_handle, PISC_SCHAR cursor_name, System::Word dialect, void * in_sqlda, void * out_sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_prepare)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_SCHAR stmt_name, System::Word length, PISC_SCHAR string_, System::Word dialect, void * sqlda);

typedef NativeInt __stdcall (*Tisc_embed_dsql_release)(PISC_STATUS user_status, PISC_SCHAR stmt_name);

typedef void __stdcall (*Tisc_encode_date)(PCTimeStructure times_arg, PISC_QUAD date);

typedef void __stdcall (*Tisc_encode_sql_date)(PCTimeStructure times_arg, PISC_DATE date);

typedef void __stdcall (*Tisc_encode_sql_time)(PCTimeStructure times_arg, PISC_TIME time);

typedef void __stdcall (*Tisc_encode_timestamp)(PCTimeStructure times_arg, PISC_TIMESTAMP timestamp);

typedef int __cdecl (*Tisc_event_block)(PISC_UCHAR &event_buffer, PISC_UCHAR &result_buffer, System::Word count, ...);

typedef void __stdcall (*Tisc_event_counts)(PISC_STATUS ser_status, short buffer_length, PISC_UCHAR event_buffer, PISC_UCHAR result_buffer);

typedef NativeInt __stdcall (*Tisc_execute)(PISC_STATUS user_status, Pisc_tr_handle trans_handle, PISC_SCHAR name, void * sqlda);

typedef NativeInt __stdcall (*Tisc_execute_immediate)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, System::PSmallInt length, PISC_SCHAR string_);

typedef void __cdecl (*Tisc_expand_dpb)(PPISC_SCHAR dpb, System::PSmallInt dpb_size, PPISC_SCHAR name_buffer);

typedef NativeInt __stdcall (*Tisc_fetch)(PISC_STATUS user_status, PISC_SCHAR name, void * sqlda);

typedef int __stdcall (*Tisc_free)(void * blk);

typedef int __stdcall (*Tisc_ftof)(PISC_SCHAR string_, System::Word length1, PISC_SCHAR field, System::Word length2);

typedef NativeInt __stdcall (*Tisc_get_segment)(PISC_STATUS user_status, Pisc_blob_handle blob_handle, System::Word &length, System::Word buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_get_slice)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, PISC_QUAD array_id, short sdl_length, PISC_SCHAR sdl, short param_length, PISC_LONG param, int slice_length, void * slice, PISC_LONG return_length);

typedef NativeInt __stdcall (*Tisc_interprete)(PISC_SCHAR buffer, PISC_STATUS &status_vector);

typedef int __stdcall (*Tfb_interpret)(PISC_SCHAR buffer, unsigned v, PISC_STATUS &status_vector);

typedef int __stdcall (*Tisc_modify_dpb)(PPISC_SCHAR dpb, System::PSmallInt dpb_length, System::Word type_, PISC_SCHAR str, short str_len);

typedef NativeInt __stdcall (*Tisc_modify_user)(PISC_STATUS status, PUSER_SEC_DATA user_data);

typedef NativeInt __stdcall (*Tisc_open)(PISC_STATUS user_status, Pisc_tr_handle trans_handle, PISC_SCHAR name, void * sqlda);

typedef NativeInt __stdcall (*Tisc_open_blob)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, Pisc_blob_handle blob_handle, PISC_QUAD blob_id);

typedef NativeInt __stdcall (*Tisc_open_blob2)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, Pisc_blob_handle blob_handle, PISC_QUAD blob_id, System::Word bpb_length, PISC_UCHAR bpb);

typedef __int64 __stdcall (*Tisc_portable_integer)(PISC_UCHAR ptr, short length);

typedef NativeInt __stdcall (*Tisc_prepare)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle trans_handle, PISC_SCHAR name, System::PSmallInt length, PISC_SCHAR string_, void * sqlda);

typedef NativeInt __stdcall (*Tisc_prepare_transaction)(PISC_STATUS user_status, Pisc_tr_handle tra_handle);

typedef NativeInt __stdcall (*Tisc_prepare_transaction2)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, System::Word msg_length, PISC_UCHAR msg);

typedef NativeInt __stdcall (*Tisc_print_blr)(PISC_SCHAR blr, isc_callback callback, void * callback_argument, short language);

typedef void __stdcall (*Tisc_print_sqlerror)(short sqlcode, PISC_STATUS status_vector);

typedef NativeInt __stdcall (*Tisc_print_status)(PISC_STATUS status_vector);

typedef NativeInt __stdcall (*Tisc_put_segment)(PISC_STATUS user_status, Pisc_blob_handle blob_handle, System::Word buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_put_slice)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, PISC_QUAD array_id, short sdl_length, PISC_SCHAR sdl, short param_length, PISC_LONG param, int slice_length, void * slice);

typedef void __stdcall (*Tisc_qtoq)(PISC_QUAD quad1, PISC_QUAD quad2);

typedef NativeInt __stdcall (*Tisc_que_events)(PISC_STATUS user_status, Pisc_db_handle handle, PISC_LONG id, short length, PISC_UCHAR events, isc_callback ast, void * arg);

typedef NativeInt __stdcall (*Tisc_receive)(PISC_STATUS user_status, Pisc_req_handle req_handle, short msg_type, short msg_length, void * msg, short level);

typedef NativeInt __stdcall (*Tisc_reconnect_transaction)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, short length, PISC_SHORT id);

typedef NativeInt __stdcall (*Tisc_release_request)(PISC_STATUS user_status, Pisc_req_handle req_handle);

typedef NativeInt __stdcall (*Tisc_request_info)(PISC_STATUS user_status, Pisc_req_handle req_handle, short level, short item_length, PISC_SCHAR items, short buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_rollback_retaining)(PISC_STATUS status_vector, Pisc_tr_handle trans_handle);

typedef NativeInt __stdcall (*Tisc_rollback_transaction)(PISC_STATUS user_status, Pisc_tr_handle tra_handle);

typedef NativeInt __stdcall (*Tisc_seek_blob)(PISC_STATUS user_status, Pisc_blob_handle blob_handle, short mode, int offset, PISC_LONG Result_);

typedef NativeInt __stdcall (*Tisc_send)(PISC_STATUS user_status, Pisc_req_handle req_handle, short msg_type, short msg_length, void * msg, short level);

typedef NativeInt __stdcall (*Tisc_service_attach)(PISC_STATUS status_vector, System::Word service_length, PISC_SCHAR service_name, Pisc_svc_handle handle, System::Word spb_length, PISC_SCHAR spb);

typedef NativeInt __stdcall (*Tisc_service_detach)(PISC_STATUS status_vector, Pisc_svc_handle handle);

typedef NativeInt __stdcall (*Tisc_service_query)(PISC_STATUS status_vector, Pisc_svc_handle svc_handle, Pisc_resv_handle reserved, System::Word send_spb_length, PISC_SCHAR send_spb, System::Word request_spb_length, PISC_SCHAR request_spb, System::Word buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_service_start)(PISC_STATUS status_vector, Pisc_svc_handle svc_handle, Pisc_resv_handle reserved, System::Word spb_length, PISC_SCHAR spb);

typedef void __stdcall (*Tisc_set_debug)(int flag);

typedef void __stdcall (*Tisc_sql_interprete)(short SQLCODE, PISC_SCHAR buffer, short buffer_length);

typedef int __stdcall (*Tisc_sqlcode)(PISC_STATUS user_status);

typedef NativeInt __stdcall (*Tisc_start_and_send)(PISC_STATUS user_status, Pisc_req_handle req_handle, Pisc_tr_handle tra_handle, short msg_type, short msg_length, void * msg, short level);

typedef NativeInt __stdcall (*Tisc_start_multiple)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, short count, PISCTEB vector);

typedef NativeInt __stdcall (*Tisc_start_request)(PISC_STATUS user_status, Pisc_req_handle req_handle, Pisc_tr_handle tra_handle, short level);
...
typedef NativeInt __stdcall (*Tisc_transact_request)(PISC_STATUS user_status, Pisc_db_handle db_handle, Pisc_tr_handle tra_handle, System::Word blr_length, PISC_SCHAR blr, System::Word in_msg_length, PISC_SCHAR in_msg, System::Word out_msg_length, PISC_SCHAR out_msg);

typedef NativeInt __stdcall (*Tisc_transaction_info)(PISC_STATUS user_status, Pisc_tr_handle tra_handle, short item_length, PISC_SCHAR items, short buffer_length, PISC_SCHAR buffer);

typedef NativeInt __stdcall (*Tisc_unwind_request)(PISC_STATUS user_status, Pisc_tr_handle req_handle, short level);

typedef int __stdcall (*Tisc_vax_integer)(PISC_SCHAR ptr, short length);

typedef int __stdcall (*Tisc_version)(Pisc_db_handle db_handle, isc_callback callback, void * callback_argument);

typedef void __stdcall (*Tisc_vtof)(PISC_SCHAR string1, PISC_SCHAR string2, System::Word length);

typedef void __stdcall (*Tisc_vtov)(PISC_SCHAR string1, PISC_SCHAR string2, short length);

typedef NativeInt __stdcall (*Tisc_wait_for_event)(PISC_STATUS user_status, Pisc_db_handle handle, short length, PISC_UCHAR events, PISC_UCHAR buffer);

typedef int __stdcall (*Tisc_reset_fpe)(System::Word fpe_status);

typedef void __stdcall (*Tisc_get_client_version)(PISC_SCHAR version);

typedef int __stdcall (*Tisc_get_client_major_version)(void);

typedef int __stdcall (*Tisc_get_client_minor_version)(void);

typedef NativeInt __stdcall (*Tisc_release_savepoint)(PISC_STATUS status, Pisc_tr_handle TrHandle, PISC_SCHAR name);

typedef NativeInt __stdcall (*Tisc_rollback_savepoint)(PISC_STATUS status, Pisc_tr_handle TrHandle, PISC_SCHAR name, System::Word Option);

typedef NativeInt __stdcall (*Tisc_start_savepoint)(PISC_STATUS status, Pisc_tr_handle TrHandle, PISC_SCHAR name);

typedef NativeInt __stdcall (*Tisc_dsql_batch_execute)(PISC_STATUS status, Pisc_tr_handle TrHandle, Pisc_stmt_handle stmt_handle, System::Word dialect, void * insqlda, System::Word number_of_rows, PXSQLVAR_V2 batch_vars, PISC_ULONG rows_affected);

typedef void __stdcall (*Tfb_sqlstate)(PISC_SCHAR sqlstate, PISC_STATUS status_vector);

typedef NativeInt __stdcall (*Tfb_cancel_operation)(PISC_STATUS status, Pisc_db_handle db_handle, System::Word options);

typedef int __stdcall (*Tfb_shutdown)(unsigned timeout, int reason);

typedef NativeInt __stdcall (*Tfb_shutdown_callback)(PISC_STATUS status, FB_SHUTDOWN_CALLBACK_FUNC callback_function, int mask, void * arg);

typedef NativeInt __stdcall (*Tfb_ping)(PISC_STATUS status, Pisc_db_handle db_handle);

typedef NativeInt __stdcall (*Tfb_get_database_handle)(PISC_STATUS status, Pisc_db_handle db_handle, void * data);

typedef NativeInt __stdcall (*Tfb_get_transaction_handle)(PISC_STATUS status, Pisc_tr_handle tr_handle, void * data);

typedef IMaster* __stdcall (*Tfb_get_master_interface)(void);

typedef NativeInt __stdcall (*Tfb_dsql_set_timeout)(PISC_STATUS status, Pisc_stmt_handle stmt_handle, unsigned timeout);

typedef NativeInt __stdcall (*Tfb_get_statement_interface)(PISC_STATUS status, void * iPtr, Pisc_stmt_handle stmt_handle);
...
static const System::Int8 blr_dec64 = System::Int8(0x18);
static const System::Int8 blr_dec128 = System::Int8(0x19);
static const System::Int8 blr_int128 = System::Int8(0x1a);
static const System::Int8 blr_sql_time_tz = System::Int8(0x1c);
static const System::Int8 blr_timestamp_tz = System::Int8(0x1d);
static const System::Int8 blr_ex_time_tz = System::Int8(0x1e);
static const System::Int8 blr_ex_timestamp_tz = System::Int8(0x1f);
...
static const System::Int8 isc_dpb_session_time_zone = System::Int8(0x5b);
static const System::Int8 isc_dpb_set_db_replica = System::Int8(0x5c);
static const System::Int8 isc_dpb_set_bind = System::Int8(0x5d);
static const System::Int8 isc_dpb_decfloat_round = System::Int8(0x5e);
static const System::Int8 isc_dpb_decfloat_traps = System::Int8(0x5f);
...
static const System::Int8 isc_dpb_Max_Value_FB400 = System::Int8(0x5f);
...
static const System::Int8 isc_tpb_read_consistency = System::Int8(0x16);
static const System::Int8 isc_tpb_at_snapshot_number = System::Int8(0x17);
...
static const System::Int8 isc_info_sql_stmt_flags = System::Int8(0x1b);
static const System::Int8 isc_info_sql_stmt_timeout_user = System::Int8(0x1c);
static const System::Int8 isc_info_sql_stmt_timeout_run = System::Int8(0x1d);
static const System::Int8 isc_info_sql_stmt_blob_align = System::Int8(0x1e);
...
static const System::Word SQL_TIMESTAMP_TZ_EX = System::Word(0x7fec);
static const System::Word SQL_TIME_TZ_EX = System::Word(0x7fee);
static const System::Word SQL_INT128 = System::Word(0x7ff0);
static const System::Word SQL_TIMESTAMP_TZ = System::Word(0x7ff2);
static const System::Word SQL_TIME_TZ = System::Word(0x7ff4);
static const System::Word SQL_DEC16 = System::Word(0x7ff8);
static const System::Word SQL_DEC34 = System::Word(0x7ffa);
