...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.pas' rev: 35.00 (Windows)
...
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
typedef System::TMetaClass* TFDPhysDriverClass;
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TFDPhysDriverClass);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::TMetaClass* TFDPhysConnectionClass;
#else /* _WIN64 */
...
private:
	...
	void __fastcall RecoverConnection(const Firedac::Stan::Intf::_di_IFDStanObject AInitiator, bool AOnLogin, bool AForceRaise);
